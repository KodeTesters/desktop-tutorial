...
public class GraphSteps {
    ...
    public void the_user_is_on_the_ds_algo_home_page() {
        gp.user_click_to_login();
        // String expectedUrl = "https://dsportalapp.herokuapp.com/home"; // Replace
        // with the actual URL of the Graph page
        // String actualUrl = gp.getdriver().getCurrentUrl();

        // Assert.assertTrue("The user is not redirected to the Graph page",
